#!/usr/bin/env python3
"""
POMATO July 2024 Analysis - FBMC vs ATC
Swedish Electricity Market with Cross-Border Connections

Date Range: July 15-21, 2024 (168 hours)
Network: 13 nodes (4 Swedish + 9 neighbors), 13 lines

This is a multi-period analysis comparing summer conditions (July)
with the base case (December 2024) and winter (January 2024).
"""
...
DATA_DIR = REPO_ROOT / "data" / "july_2024"
RESULTS_DIR = REPO_ROOT / "results" / "july_2024"
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

# Date range: July 15-21, 2024 (168 hours)
START_DATE = datetime(2024, 7, 15, 0, 0)
END_DATE = datetime(2024, 7, 21, 23, 0)
NUM_HOURS = 168
...
print("=" * 70)
print("POMATO JULY 2024 ANALYSIS")
print("FBMC vs ATC - Summer Week Comparison")
print("Swedish Electricity Market - July 15-21, 2024")
print("=" * 70)
...
def load_data():
    """Load all input data from the July period directory"""
    print("\nLoading input data from periods/july_2024/data/...")
    ...
    print("\nNeighbor prices (EUR/MWh) - July 2024:")
...
def main():
    ...
    # Calculate results
    print("\n" + "=" * 70)
    print("RESULTS SUMMARY - July 15-21, 2024")
    print("=" * 70)
    ...
    print(f"\nSaved: periods/july_2024/results/summary.csv")
...
if __name__ == "__main__":
    ...
    # Print comparison with all periods
    print("\n" + "=" * 70)
    print("THREE-PERIOD COMPARISON")
    print("=" * 70)

    # December and January results (from previous analyses)
    dec_results = {
        'savings_pct': 6.54,
        'savings_eur': 4367261,
        'se23_util': 88,
    ...
    jan_results = {
        'savings_pct': 12.63,  # Note: absolute value, FBMC is better
        'savings_eur': 6357506,
        'se23_util': 90.6,
        'no4_price': 16.20,
        'mean_demand': 20094,
    ...
    jul_results = {
        ...
        'savings_eur': results['atc_total'] - results['fbmc_total'],
        'se23_util': results['se23_fbmc_util'],
        'no4_price': NEIGHBOR_PRICES['NO4'],
        'mean_demand': 10847,  # Sum of zone means
        'solar_avail': 0.090
    }

    print(f"\n{'Metric':<30} {'Dec 2024 (Base)':>18} {'Jan 2024 (Winter)':>18} {'Jul 2024 (Summer)':>18}")
    print("-" * 85)
    print(f"{'FBMC Savings (EUR)':<30} {dec_results['savings_eur']:>17,} {jan_results['savings_eur']:>17,} {jul_results['savings_eur']:>17,.0f}")
    print(f"{'SE2-SE3 Congestion (%)':<30} {dec_results['se23_util']:>17.1f}% {jan_results['se23_util']:>17.1f}% {jul_results['se23_util']:>17.1f}%")
    print(f"{'Mean Demand (MW)':<30} {dec_results['mean_demand']:>18,} {jan_results['mean_demand']:>18,} {jul_results['mean_demand']:>18,}")
    print(f"{'NO4 Price (EUR/MWh)':<30} {dec_results['no4_price']:>18.2f} {jan_results['no4_price']:>18.2f} {jul_results['no4_price']:>18.2f}")
    print(f"{'Solar Availability':<30} {dec_results['solar_avail']:>17.1%} {jan_results['solar_avail']:>17.1%} {jul_results['solar_avail']:>17.1%}")
